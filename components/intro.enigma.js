...
function IntroTrail(props) {
  ...
  _getLocationAsync = async () => {
    ...
    Location.watchPositionAsync({ distanceInterval: 0.5 }, loc => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        >
          <Marker
            ...
            coordinate={{ latitude: enigmaPos.lat, longitude: enigmaPos.long }}
            image={require("../assets/pin.svg")}
          />
        </MapView>
        <View>
          <Text>Alo</Text>
      ...
      <TouchableOpacity
        ...
        disabled={nextStep.isNext === true ? false : true}
        onPress={() => {
          navigate("Louvre1", { enigmaContent: enigmaContent });
        }}
      >
        <Text style={styles.textCTA}>
          {nextStep.isNext === true
            ? nextStep.msg
            : "Rapprochez vous du départ !"}
        </Text>
      </TouchableOpacity>
    </View>
  );
